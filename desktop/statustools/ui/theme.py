...
DARK = WidgetTheme(
    name="dark",
    bg=QColor(24, 24, 32),
    bg_dim=QColor(15, 15, 21),
    border=QColor(255, 255, 255, 30),
    glow=QColor(255, 255, 255, 42),
    fg=QColor(235, 236, 240),
    fg_dim=QColor(150, 152, 160),
    track=QColor(255, 255, 255, 22),
    card=QColor(255, 255, 255, 16),
    card_border=QColor(255, 255, 255, 26),
    button=QColor(255, 255, 255, 16),
    button_hover=QColor(255, 255, 255, 38),
...
LIGHT = WidgetTheme(
    name="light",
    bg=QColor(252, 252, 255),
    bg_dim=QColor(236, 237, 244),
    border=QColor(0, 0, 0, 26),
    glow=QColor(255, 255, 255, 150),
    fg=QColor(24, 24, 32),
    fg_dim=QColor(108, 110, 122),
    track=QColor(0, 0, 0, 26),
    card=QColor(255, 255, 255, 110),
    card_border=QColor(255, 255, 255, 200),
    button=QColor(0, 0, 0, 12),
    button_hover=QColor(0, 0, 0, 28),
